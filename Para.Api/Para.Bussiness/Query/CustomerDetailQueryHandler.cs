...
namespace Para.Bussiness.Query
{
    ...
    IRequestHandler<GetAllCustomerDetailByIdQuery, ApiResponse<CustomerDetailResponse>>,
    IRequestHandler<GetCustomerDetailByParametersQuery, ApiResponse<CustomerDetailResponse>>
    {
        ...
        public async Task<ApiResponse<CustomerDetailResponse>> Handle(GetAllCustomerDetailByIdQuery request, CancellationToken cancellationToken)
        {
        ...
        public async Task<ApiResponse<CustomerDetailResponse>> Handle(GetCustomerDetailByParametersQuery request, CancellationToken cancellationToken)
        {
            var entity = await unitOfWork.CustomerDetailRepository.GetAll();
